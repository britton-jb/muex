defmodule Muex.ConfigTest do
  ...
  describe "from_args/1" do
    test "returns defaults when no args provided" do
      ...
      assert Muex.Mutator.NegateConditionals in config.mutators
      ...
      assert Muex.Mutator.WithClause in config.mutators
      assert Muex.Mutator.MapSemantics in config.mutators
